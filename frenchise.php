		...
		<div class='header'>
			<div class="logo-container">
				...
				<div class="menu-header">
					<div class="pull-right button-top btn-shadow-red btn-shadow-grey">Contact</div>
					<div class="pull-right button-top btn-shadow-violet btn-shadow-grey">Member</div>
					<div class="pull-right button-top btn-shadow-blue">Frenchise</div>
					<a href="." class="pull-right button-top btn-shadow-green btn-shadow-grey">Home</a>
				</div>
			</div>
		</div>
		<div class="clear"></div>
